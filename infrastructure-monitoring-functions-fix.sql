-- TBWA Infrastructure Monitoring Functions - Fixed Version
-- Drop existing functions first to avoid conflicts

-- Drop existing functions
DROP FUNCTION IF EXISTS get_database_summary();
DROP FUNCTION IF EXISTS check_scout_schema_status();
DROP FUNCTION IF EXISTS get_storage_report();
DROP FUNCTION IF EXISTS analyze_scout_schema();
...
FROM pg_proc 
WHERE proname IN ('get_database_summary', 'check_scout_schema_status', 'get_storage_report', 'analyze_scout_schema')
ORDER BY proname;